...
public class StudentSubjects extends javax.swing.JFrame {

    public StudentSubjects() {
        initComponents();
         this.setExtendedState(StudentSubjects.MAXIMIZED_BOTH);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentSubjects.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentSubjects().setVisible(true);
            }
        });
    }
