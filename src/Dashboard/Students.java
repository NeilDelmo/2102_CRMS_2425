...
private void LoadStudents() {
    ...
    String query = "SELECT students.student_id, students.student_lastname, students.student_firstname, sections.section_code " +
                   "FROM students " +
                   "LEFT JOIN sections ON students.section_code = sections.section_code"; // Using LEFT JOIN to ensure all students are retrieved, even if they have no section
    ...
    try (Connection con = DriverManager.getConnection(URL, USER, PASS)) { 
        ...
        while (rs.next()) {
            ...
            String section_code = rs.getString("section_code");  // NULL-safe if sections.section_id doesn't match

            if (section_code == null) {
                section_code = "Unassigned"; // Placeholder for students without a section
            }

            model.addRow(new Object[]{id, lastName, firstName, section_code});
        }
    ...
    private void initComponents() {
        ...
        btnGrades_Students = new rojeru_san.complementos.RSButtonHover();
        ...
        btnGrades_Students.setBackground(new java.awt.Color(255, 255, 255));
        btnGrades_Students.setForeground(new java.awt.Color(0, 0, 0));
        btnGrades_Students.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/grades.png"))); // NOI18N
        btnGrades_Students.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGrades_StudentsActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnTeach_Students, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE)
                    ...
                    .addComponent(btnGrades_Students, javax.swing.GroupLayout.DEFAULT_SIZE, 86, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnGrades_Students, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void btnGrades_StudentsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGrades_StudentsActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnGrades_StudentsActionPerformed
    ...
    private rojeru_san.complementos.RSButtonHover btnGrades_Students;
