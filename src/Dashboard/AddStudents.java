...
private void setupEnterKeyNavigation() {
    ...
    private void validateAndCreateStudent() {
        ...
        String section_code = (String) sectionsComboBox.getSelectedItem();

        if (firstNameText.isEmpty() || lastNameText.isEmpty() || section_code == null) {
        ...
        createStudent(firstNameText, lastNameText, section_code);
    }
