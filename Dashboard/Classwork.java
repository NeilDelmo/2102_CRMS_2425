...
private void LoadStudents(){
    String query = "SELECT student_id, student_lastname, student_lastname FROM students";
    
}
private void displayClasswork() {
    DefaultTableModel model = (DefaultTableModel) ClassworkTable.getModel();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btnGrades_Classwork, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        ClassworkTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Student_id", "Last Name", "First Name", "section", "Activity 1", "Activity 2", "Activity 3", "Activity 4", "Activity 5", "Activity 6", "Activity 7", "Activity 8", "Activity 9", "Activity 10", "Midterms", "Finals", "Project", "Average"
            }
        ) {
        ...
        jScrollPane2.setViewportView(ClassworkTable);
