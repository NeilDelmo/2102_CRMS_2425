...
public class AccountManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnSections_AccountManagement.setBackground(new java.awt.Color(255, 255, 255));
        btnSections_AccountManagement.setForeground(new java.awt.Color(0, 0, 0));
        btnSections_AccountManagement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/section.png"))); // NOI18N
        btnSections_AccountManagement.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSections_AccountManagementActionPerformed(evt);
            }
        });

        btnRooms_AccountManagement.setBackground(new java.awt.Color(255, 255, 255));
        btnRooms_AccountManagement.setForeground(new java.awt.Color(0, 0, 0));
        btnRooms_AccountManagement.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/classroom.png"))); // NOI18N
        btnRooms_AccountManagement.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRooms_AccountManagementActionPerformed(evt);
            }
        });
    ...
    private void btnSections_AccountManagementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSections_AccountManagementActionPerformed
        ...
        this.dispose();
    }//GEN-LAST:event_btnSections_AccountManagementActionPerformed

    private void btnRooms_AccountManagementActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRooms_AccountManagementActionPerformed
        // TODO add your handling code here:
    ...
    private rojeru_san.complementos.RSButtonHover btnRooms_AccountManagement;
