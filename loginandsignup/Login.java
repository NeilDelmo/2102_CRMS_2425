...
import StudentPackage.HomeStudent;  
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        ShowPassword.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/showpass.com.png"))); // NOI18N
                ...
                if (userType.equals("Teacher")) {
                    ...
                    if (rs.next()) {
                        ...
                        if (password.equals(passDb)) {
                            int teachers_id = rs.getInt("teachers_id");
                            Home dashboard = new Home(teachers_id);
                    ...
                    if (rs.next()) {
                        passDb = rs.getString("password");
                        if (password.equals(passDb)) {
                            int student_id = rs.getInt("student_account_id");
                            HomeStudent studentDashboard = new HomeStudent(student_id);
