...
public class AddSection extends javax.swing.JFrame {
    ...
    try {
        Integer.parseInt(sectionCodeText);
    ...
    CreateSection(sectionNameText, Integer.parseInt(sectionCodeText));
    }
    ...
    try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
        ...
        // Check for SQL state or error code related to unique constraint violations
        if (ex.getSQLState().equals("23000") || ex.getMessage().contains("Duplicate")) {
            ...
            ex.printStackTrace();
            JOptionPane.showMessageDialog(this, "Error creating section: " + ex.getMessage(),
                    "Database Error", JOptionPane.ERROR_MESSAGE);
        }
    }
}
